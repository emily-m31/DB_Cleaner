...
¿Sería posible resolver esta consulta utilizando el operador de suma + o resta -?: NO ES RECOMENDABLE YA QUE SQL NO MANEJA MUY BIEN LAS FECHAS CON OPERADORES SIMPLES */
select codigo_pedido, codigo_cliente, fecha_esperada, fecha_entrega
from pedido
...
descripcion_html,
imagen
from gama_producto;  PRIMARY KEY (gama)
);
